const Testimonial = () => {
  ...
  return (
    <div className="mt-48 sm:mt-60 lg:mt-72"> {/* ⬅️ Increased top margin */}
      {/* Heading */}
      <h2 className="text-center text-3xl sm:text-4xl font-bold text-gray-900 mb-12">
        Loved by Many Team Leads <br/> and Members
      </h2>
      ...
      <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
        ...
        <div className="absolute right-0 top-0 h-full w-20 md:w-40 bg-gradient-to-l from-white to-transparent pointer-events-none"></div>
      </div>
