  ...
  const getProjectSubItems = (projectId) => [
    {
      title: "Tasks",
      icon: KanbanIcon,
      url: `/layout/projectsDetail?id=${projectId}&tab=tasks`,
    },
    {
      title: "Analytics",
      icon: ChartColumnIcon,
      url: `/layout/projectsDetail?id=${projectId}&tab=analytics`,
    },
    {
      title: "Calendar",
      icon: CalendarIcon,
      url: `/layout/projectsDetail?id=${projectId}&tab=calendar`,
    },
    {
      title: "Settings",
      icon: SettingsIcon,
      url: `/layout/projectsDetail?id=${projectId}&tab=settings`,
    },
  ];
